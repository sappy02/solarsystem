...
const solarSystem = [
    ...
    // console.log(solarSystem.find(planet => planet.name === "Mercury"));
    
    // // 7. Change Uranus' moon "Umbriel" to "Oberon"
    // const uranus = solarSystem.find(planet => planet.name === "Uranus");
    // const moonIndex = uranus.moons.indexOf("Umbriel");
    // if (moonIndex !== -1) {
    ...
    // console.log("Planets with ring systems:");
    ...
    // const totalSatellites = parseInt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
    ...
    // console.log("Mercury's radiusp:", system.mercury.radiusp);
    ...
    function calculateMomentum(planet) {
        return planet.velocity * planet.mass;
    }

    // Calculate momentum for Jupiter and Pluto
    const jupiterMomentum = calculateMomentum(system.jupiter);
    const plutoMomentum = calculateMomentum(system.pluto);

    // Find the difference
    const momentumDifference = jupiterMomentum - plutoMomentum;
